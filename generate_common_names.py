#!/usr/bin/env python3
"""Generate a JSON mapping of scientific name -> common name for vertebrate species."""
import json

# Comprehensive common name mapping for vertebrate species in the tAIatlas database.
# This covers mammals, birds, reptiles, amphibians, and fish.
COMMON_NAMES = {
    # --- MAMMALS ---
    ...
    "Colobus angolensis palliatus": "Peters' Angola Colobus",
    ...
    "Macaca thibetana thibetana": "Tibetan Macaque",
    ...
    "Gallus gallus": "Red Junglefowl (Chicken)",
    ...
    "Indicador indicator": "Greater Honeyguide",
    "Indicador indicator": "Greater Honeyguide",
    ...
    "Pithys albifrons albifrons": "White-plumed Antbird",
    ...
    "Sphaerodactylus townsendi": "Townsend's Gecko",
    ...
    "Microcaecilia unicolor": "Tiny Caecilian",
    ...
    "Ranitomeya variabilis": "Variable Poison Frog",
    ...
    "Bagarius yarrelli": "Giant Devil Catfish",
    "Bagrus docmak": "Semutundu Catfish",
    "Betta splendens": "Siamese Fighting Fish",
    "Boleophthalmus pectinirostris": "Mudskipper",
    "Brachyhypopomus occidentalis": "Knifefish",
    "Callorhinchus milii": "Ghost Shark (Elephant Fish)",
    ...
    "Erpetoichthys calabaricus": "Reedfish (Ropefish)",
    ...
    "Girardinichthys multiradiatus": "Amarillo Fish",
    ...
    "Lampris incognitus": "North Pacific Opah",
    ...
    "Leucoraja erinaceus": "Little Skate",
    ...
    "Megalobrama amblycephala": "Wuhan Bream",
    ...
    "Myxocyprinus asiaticus": "Chinese Hi-fin Banded Shark",
    "Narcine bancroftii": "Lesser Electric Ray",
    "Nematolebias whitei": "Rio Pearlfish",
    "Neoarius graeffei": "Blue Catfish (Australian)",
    "Nerophis lumbriciformis": "Straight-nose Pipefish",
    "Nerophis ophidion": "Straightnose Pipefish",
    "Nothobranchius furzeri": "Turquoise Killifish",
    "Notolabrus celidotus": "Spotty Wrasse",
    "Notothenia rossii": "Marbled Rockcod",
    "Odontesthes bonariensis": "Argentine Silverside",
    ...
    "Onychostoma macrolepis": "Largescale Soro",
    ...
    "Pangasianodon hypophthalmus": "Iridescent Shark Catfish",
    "Paralichthys olivaceus": "Japanese Flounder",
    "Parambassis ranga": "Indian Glassy Fish",
    "Paramisgurnus dabryanus": "Chinese Loach",
    "Paramormyrops kingsleyae": "Kingsley's Mormyrid",
    ...
    "Rhinoraja longicauda": "Longtail Skate",
    ...
    "Salvelinus sp. IW2-2015": "Iwana Charr",
    ...
    "Seriola aureovittata": "Yellowtail Amberjack",
    ...
    "Tachysurus vachellii": "Darkbarbel Catfish",
    "Takifugu flavidus": "Yellowfin Pufferfish",
    "Takifugu rubripes": "Japanese Pufferfish (Fugu)",
    "Thalassophryne amazonica": "Amazonian Toadfish",
    "Thunnus albacares": "Yellowfin Tuna",
    "Thunnus maccoyii": "Southern Bluefin Tuna",
    "Thunnus thynnus": "Atlantic Bluefin Tuna",
    "Toxotes jaculatrix": "Banded Archerfish",
    "Trichomycterus rosablanca": "White Rose Pencil Catfish",
    "Triplophysa dalaica": "Dalai Loach",
    "Triplophysa rosa": "Pink Loach",
...
# Output as JSON
with open("tAIatlas/taiatlas.github.io/data/common_names.json", "w") as f:
    json.dump(COMMON_NAMES, f, indent=2)

print(f"Wrote {len(COMMON_NAMES)} common name mappings to data/common_names.json")
